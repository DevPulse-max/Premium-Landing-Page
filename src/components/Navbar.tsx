      ...
      >
        <div className="flex items-center justify-between">
          ...
          <button 
            ...
            id="nav-logo"
          >
            <div className="relative flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-[#ff7a1a] to-[#ffb15c] p-1.5 shadow-[0_0_15px_rgba(255,122,26,0.3)] group-hover:shadow-[0_0_25px_rgba(255,122,26,0.5)] transition-all duration-300">
